...
public class CronMarketingMail implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        timer.scheduleAtFixedRate(new MyTask(), 0, 30L * 24L * 60L * 60L * 1000L); //60s
    }
    ...
    private static class MyTask extends TimerTask {
        ...
        public void run() {
            ...
            try {
                List<UserModel> listUserOfflineOver30Day = userService.findByColumnValues(subQueryList,null);
